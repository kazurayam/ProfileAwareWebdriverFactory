...
class ChromeOptionsModifierTest {
    ...
    @Test
    void test_headless() {
        ChromeOptions modified = ChromeOptionsModifiers
                .headless().modify(options)
    ...
    void test_windowSize1024_768() {
        ChromeOptions modified = ChromeOptionsModifiers
                .windowSize1024_768().modify(options)
    ...
    void test_windowSize() {
        ChromeOptions modified = ChromeOptionsModifiers
                .windowSize(800, 600).modify(options)
